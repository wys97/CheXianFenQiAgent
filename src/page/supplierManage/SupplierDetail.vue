    ...
    <div class="content">
      <div>
        <el-tabs type="card" @tab-click="handleClick">
          ...
          <el-tab-pane label="分期申请信息" v-if="states.isHasOrderInfo">
            ...
            >
              ...
              <el-form-item label="分期期数：">
                <span>{{this.installmentData.installmentNum}}</span>
              </el-form-item>
              ...
              <el-form-item label="商业险金额：">
                <span>{{this.installmentData.installmentAmount}}</span>
              </el-form-item>
              <el-form-item label="交强险金额：">
                <span>{{this.installmentData.strongAmount}}</span>
              </el-form-item>
              <el-form-item label="车船税金额：">
                <span>{{this.installmentData.taxAmont}}</span>
              </el-form-item>
            </el-form>
          </el-tab-pane>
          <el-tab-pane label="保单信息" v-if="states.isHasPolicyInfo">
            ...
            >
              ...
              <el-form-item label="保费总额：">
                 <span>{{this.selectPolicyInfoData.policyAmount}}</span>
              </el-form-item>
              <el-form-item label="商业险总额：">
               <span>{{this.selectPolicyInfoData.installmentAmount}}</span>
              </el-form-item>
              <el-form-item label="交强险：">
                <span>{{this.selectPolicyInfoData.strongAmount}}</span>
              </el-form-item>
              <el-form-item label="车船税：">
                <span>{{this.selectPolicyInfoData.taxAmont}}</span>
              </el-form-item>
          ...
          <el-tab-pane label="还款计划" v-if="states.isHasRepaymentPlan" style="padding-bottom:100px">
            <el-form
              ref="form"
              label-width="180px"
              size="small"
              style="width:615px; margin:60px 200px 0"
            >
              ...
              <el-form-item label="分期总额：">
               <span>{{this.planInfo.installmentAmount}}</span>
              </el-form-item>
              <el-form-item label="分期期数：">
               <span>{{this.planInfo.installmentNum}}</span>
              ...
              <el-form-item label="首付金额：">
                 <span>{{this.planInfo.firstAmount}}</span>
              </el-form-item>
              <el-form-item>
                <div>交强险 {{this.planInfo.strongAmount}}元+车船税 {{this.planInfo.taxAmont}}元+保证金 {{this.planInfo.depositAmount}}元+线上服务费 {{this.planInfo.onlineServiceCharge}}元 首付保证金率=100%/总期数</div>
              </el-form-item>
              <hr style="width:160%" />
