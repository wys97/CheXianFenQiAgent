...
export function queryEnterpriseInfo(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_enterprise_info',
        method: 'post',
        data
    })
}
...
export function modEnterpriseInfo({ supplierId, name, businessLicenseNo, address, establishDate, phone, fax }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/mod_enterprise_info',
        method: 'post',
        data
    })
}
...
export function queryEquity(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_equity',
        method: 'post',
        data
    })
}
...
export function saveEquity({ supplierId, info }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/save_equity',
        method: 'post',
        data
    })
}
...
export function queryOffice(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_office',
        method: 'post',
        data
    })
}
...
export function saveOffice({ supplierId, info }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/save_office',
        method: 'post',
        data
    })
}
...
export function queryLitigation(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_litigation',
        method: 'post',
        data
    })
}
...
export function saveLitigation({ supplierId, info }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/save_litigation',
        method: 'post',
        data
    })
}
...
export function queryManager(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_manager',
        method: 'post',
        data
    })
}
...
export function queryRepreManager({ supplierId, type }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_repre_manager',
        method: 'post',
        data
    })
}
...
export function saveManager({ supplierId, info }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/save_manager',
        method: 'post',
        data
    })
}
...
export function queryCredit(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_credit',
        method: 'post',
        data
    })
}
...
export function saveCredit({ supplierId, info }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/save_credit',
        method: 'post',
        data
    })
}
...
export function queryPaper(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_paper',
        method: 'post',
        data
    })
}
...
export function queryPaperByType({ supplierId, type }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_paper_by_type',
        method: 'post',
        data
    })
}
...
export function savePaper({ supplierId, info }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/save_paper',
        method: 'post',
        data
    })
}
...
export function queryEnterpriseTrade(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_enterprise_trade',
        method: 'post',
        data
    })
}
...
export function streamVolumesStatus() {
    return fetch({
        url: test + '/agent-api/supplier_register/stream_volumes_status',
        method: 'post'
    })
}
/**
...
export function updateEnterpriseTrade({ supplierId, receivableAmount, receivableOtherAmount, payableAmount, payableOtherAmount, upstreamVerifiable, upstreamVolumes, downstreamVerifiable, downstreamVolumes }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/update_enterprise_trade',
        method: 'post',
        data
    })
}
...
export function queryEnterpriseFinance(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_enterprise_finance',
        method: 'post',
        data
    })
}
...
export function saveEnterpriseFinance({ supplierId, profitAmount, interestAmount, loanAmount, guarantyAmount, assetsAmount, turnoverAmount, receivableAmount, backgroundYears, controllerAssets }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/save_enterprise_finance',
        method: 'post',
        data
    })
}
...
export function queryEnterpriseOpinion(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_enterprise_opinion',
        method: 'post',
        data
    })
}
...
export function saveEnterpriseOpinion({ supplierId, opinionData }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/save_enterprise_opinion',
        method: 'post',
        data
    })
}
...
export function queryEnterpriseGuarantor(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_enterprise_guarantor',
        method: 'post',
        data
    })
}
...
export function selectGuarantorList(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/select_guarantor_list',
        method: 'post',
        data
    })
}
...
export function createTestKey(guarantorId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/create_test_key',
        method: 'post',
        data
    })
}
...
export function deleteEnterpriseGuarantor(guarantorId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/delete_enterprise_guarantor',
        method: 'post',
        data
    })
}
...
export function saveEnterpriseGuarantor({ supplierId, guarantorId, name, address, identityNo, mobile, email, identityFrontKey, identityBackKey, guaranteeValue, guaranteeValueFile }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/save_enterprise_guarantor',
        method: 'post',
        data
    })
}
...
export function queryDistributor(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_distributor',
        method: 'post',
        data
    })
}
...
export function deleteDistributor({ supplierId, centreId }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/delete_distributor',
        method: 'post',
        data
    })
}
...
export function operateDistributor({ centreId, name, username, password, companyName, businessLicense, contractName, contractNum, validDate, bankCode, bankBranch, bankAccountNum, files, supplierId }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/operate_distributor',
        method: 'post',
        data
    })
}
...
export function agentInfo(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/combobox/agent_info',
        method: 'post',
        data
    })
}
...
export function memberType(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/combobox/member_type',
        method: 'post',
        data
    })
}
...
export function levelInfo(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/combobox/level_info',
        method: 'post',
        data
    })
}
...
export function certificateType(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/combobox/certificate_type',
        method: 'post',
        data
    })
}
...
export function creditBelong({ supplierId, type }) {
    ...
    return fetch({
        url: test + '/agent-api/combobox/credit_belong',
        method: 'post',
        data
    })
}
...
export function identityType({ supplierId, type }) {
    ...
    return fetch({
        url: test + '/agent-api/combobox/identity_type',
        method: 'post',
        data
    })
}
...
export function submitCheck(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/submit_check',
        method: 'post',
        data
    })
}
