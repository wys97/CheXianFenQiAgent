 ...
 *@param capitalId 资金方编号
 * */
export function saveLoanfee({capitalId,overdueRate,loanFee,marginRate,chargeRate,interestRate}){
	let data = {
		capitalId,
		overdueRate,
		loanFee,
 ...
 *@param capitalId 资金方编号
 * */
export function saveSignSetup({capitalId,method,financeMethod}){
	let data = {
		capitalId,
		method,
		financeMethod
