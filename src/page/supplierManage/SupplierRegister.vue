<template>
  <div class="page-container" ref="page-container" id="page-container" style="overflow:auto">
    ...
    <div class="title_wrap">
      <div>分期申请补充</div>
      <el-button type="primary" size="medium" @click="newApplicationBtn">新增分期申请</el-button>
    </div>
    ...
    >
      ...
      <el-table-column label="VIN码" prop="frameNo" width="180" align="center"></el-table-column>

      <el-table-column prop="insuredName" width="140" label="被保人" align="center"></el-table-column>

      <el-table-column prop="insuredPhone" label="被保人手机号" align="center"></el-table-column>

      <el-table-column prop="installmentAmount" width="130" label="分期总额" align="center"></el-table-column>

      <el-table-column prop="partnerName" width="230" label="投保企业名称" align="center"></el-table-column>
      ...
      <el-table-column label="操作" width="300">
        ...
        >
          ...
          <router-link
            v-if="scope.row.status=='待补充' || scope.row.status=='被退回'"
    ...
    >
      <el-form ref="form" :model="insurance" label-width="180px" size="medium" :rules="rules2">
        ...
        <el-form-item label="电子发票：" prop="aa">
          <el-upload
            class="avatar-uploader"
            action="/agent-api/apply_supplement/upload_invoice"
        ...
        <el-form-item label="开票日期：">
          ...
          <el-col :span="18">日期格式: 0000-00-00</el-col>
        </el-form-item>
  ...
  methods: {
      ...
      if (
        ...
        networkRequest
          ...
          .then(result => {
            ...
            //上传发票ocr识别
            axiosRequest({
              url: "" + "/agent-api/apply_supplement/upload_invoice",
              method: "post",
              data: { ...data },
              headers: { "Content-Type": "application/json" }
            }).then(res => {
    ...
    insuranceDialogSave() {
      ...
      if (insurance.expire) {
        ...
        if (a == "年" && b == "月" && c == "日") {
          time =
            insurance.expire.slice(0, 4) +
            "-" +
            insurance.expire.slice(5, 7) +
            "-" +
            insurance.expire.slice(8, 10);
        } else {
