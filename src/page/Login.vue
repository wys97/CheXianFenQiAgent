<template>
  <div class="login-container" v-on:keyup.enter="handleLogin">
    ...
    <div class="login_title">
        <img src="../assets/imgs/东西汇1.png" alt class="logo_icon" />
        <h5 class="title">车险分期代理商管理后台</h5>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      ChangeVerifySrc () {
        ...
        this.verifySrc = '/agent-api/login/captcha?d=' + time
      },
      // 登录
      handleLogin () {
    ...
    created () {
      this.verifySrc = '/agent-api/login/captcha'
    },
    mounted () {
      // this.getUserInfo()
      const that = this
