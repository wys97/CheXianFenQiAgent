...
export function scoreCardSave({cardId,cardNo,cardName,sceneType,cardType,thresholdALow,thresholdAHigh,thresholdBLow,thresholdBHigh,thresholdCLow,thresholdCHigh,thresholdDLow,thresholdDHigh,status,remark}){
	let data = {
		cardId,
		cardNo,
		cardName,
...
export function scoreCardAdd({cardNo,cardName,sceneType,cardType,thresholdALow,thresholdAHigh,thresholdBLow,thresholdBHigh,thresholdCLow,thresholdCHigh,thresholdDLow,thresholdDHigh,status,remark}){
	let data = {
		cardNo,
		cardName,
		sceneType,
