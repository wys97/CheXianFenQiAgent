      ...
      <div>
        <el-tabs type="card" @tab-click="handleClick">
            ...
            >
              ...
              <el-form-item>
                <div style="display:flex; align-items:center;">
                  <img
                    :src="selectPolicyInfoData.policyUrl"
                    v-if="selectPolicyInfoData.policyUrl"
                    style="width:120px; height:120px; "
                  />
                  <img
                    :src="selectPolicyInfoData.invoiceUrl"
                    v-if="selectPolicyInfoData.invoiceUrl"
                    style="width:120px; height:120px; margin:0 10px "
                  />
                  <img
                    :src="selectPolicyInfoData.payVoucherUrl"
                    v-if="selectPolicyInfoData.payVoucherUrl"
                    style="width:120px; height:120px"
                  />
                </div>
              </el-form-item>
          ...
          <el-tab-pane label="还款计划" v-if="states.isHasRepaymentPlan">
            ...
            <el-table :data="orderPlanList" border style="width: 50%; margin: 0 auto 100px">
