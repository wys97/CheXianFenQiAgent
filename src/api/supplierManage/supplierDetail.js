...
export function detailTop(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/apply_register/detail_top',
        method: 'post',
        data
    })
}
...
export function detail(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/apply_register/detail',
        method: 'post',
        data
    })
}
...
export function detailRegister(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/apply_register/detail_register',
        method: 'post',
        data
    })
}
...
export function detailRepulse({ supplierId, remark }) {
    ...
    return fetch({
        url: test + '/agent-api/apply_register/detail_repulse',
        method: 'post',
        data
    })
}
...
export function queryBasic(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_basic',
        method: 'post',
        data
    })
}
...
export function queryBasicInspection(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_basic_inspection',
        method: 'post',
        data
    })
}
...
export function queryVerifyInspection(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_verify_inspection',
        method: 'post',
        data
    })
}
...
export function querySignInspection(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_sign_inspection',
        method: 'post',
        data
    })
}
...
export function approveBasic({ amendItems, amendRemark, inspections, pass, supplierId }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/approve_basic',
        method: 'post',
        data
    })
}
...
export function approveVerify({ inspections, supplierId }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/approve_verify',
        method: 'post',
        data
    })
}
...
export function amendingVerify({ inspections, supplierId, remark }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/amending_verify',
        method: 'post',
        data
    })
}
...
export function reapproveVerify(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/reapprove_verify',
        method: 'post',
        data
    })
}
...
export function approveSign({ inspections, supplierId }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/approve_sign',
        method: 'post',
        data
    })
}
...
export function amendingSign({ inspections, supplierId, remark }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/amending_sign',
        method: 'post',
        data
    })
}
...
export function approvefinal({ supplierId, rejectRemark, pass }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/approve_final',
        method: 'post',
        data
    })
}
...
export function queryBasicRmSummary(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_basic_rm_summary',
        method: 'post',
        data
    })
}
...
export function queryBasicRmDetail(item, supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_basic_rm_detail',
        method: 'post',
        data
    })
}
...
export function reApproveBasic(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/reapprove_basic',
        method: 'post',
        data
    })
}
...
export function queryTrade(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_trade',
        method: 'post',
        data
    })
}
...
export function queryTradeInspection(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_trade_inspection',
        method: 'post',
        data
    })
}
...
export function contractStatus(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/contract_status',
        method: 'post',
        data
    })
}
...
export function commerceFactorContract(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/commerce_factor_contract',
        method: 'post',
        data
    })
}
...
export function guaranteeAgreement(guarantorId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/guarantee_agreement',
        method: 'post',
        data
    })
}
...
export function createFactorContract(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/create_factor_contract',
        method: 'post',
        data
    })
}
...
export function createGuaranteeContract(guarantorId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/create_guarantee_contract',
        method: 'post',
        data
    })
}
...
export function approveTrade({ amendItems, amendRemark, inspections, pass, supplierId }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/approve_trade',
        method: 'post',
        data
    })
}
...
export function queryTradeRmSummary(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_trade_rm_summary',
        method: 'post',
        data
    })
}
...
export function queryTradeRmDetail(item, supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_trade_rm_detail',
        method: 'post',
        data
    })
}
...
export function reApproveTrade(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/reapprove_trade',
        method: 'post',
        data
    })
}
...
export function queryKnow(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_know',
        method: 'post',
        data
    })
}
...
export function updateKnow({ supplierId, credit, trade }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/update_know',
        method: 'post',
        data
    })
}
...
export function approveKnow(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/approve_know',
        method: 'post',
        data
    })
}
...
export function queryVerify(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_verify',
        method: 'post',
        data
    })
}
...
export function updateVerify({ supplierId, creditEnterprise, creditRepre, creditGuarantor, centres }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/update_verify',
        method: 'post',
        data
    })
}
...
export function queryVerifyRmSummary(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_verify_rm_summary',
        method: 'post',
        data
    })
}
...
export function queryVerifyRmDetail(supplierId, creditType) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_verify_rm_detail',
        method: 'post',
        data
    })
}
...
export function uploadVerify(data) {
    return fetch({
        url: test + '/agent-api/supplier_register/upload_verify',
        method: 'post',
        isFormData: true,
...
export function querySign(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_sign',
        method: 'post',
        data
    })
}
...
export function evaluateGrade(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/evaluate_grade',
        method: 'post',
        data
    })
}
...
export function queryGrade(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_grade',
        method: 'post',
        data
    })
}
...
export function queryGradeDetail(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_grade_detail',
        method: 'post',
        data
    })
}
...
export function calculatedInterest(loanRate) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/calculated_interest',
        method: 'post',
        data
    })
}
...
export function updateSign({ supplierId, capitalId, totalCreditLine, creditLineExpireTime, interestRate, overdueRate, chargeRate, marginRate, creditAndIterestRate }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/update_sign',
        method: 'post',
        data
    })
}
...
export function saveApproveTrade(supplierId, vendorCode) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/saveApprove_trade',
        method: 'post',
        data
    })
...
export function informationCheck({ supplierId, type }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/information_check',
        method: 'post',
        data
    })
...
export function getScoreCard(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_scorecard',
        method: 'post',
        data
    })
...
export function remitConfirm(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/remit/confirm',
        method: 'post',
        data
    })
...
export function refreshTrade(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/refresh_trade',
        method: 'post',
        data
    })
...
export function addCentre({ supplierId, centreIds }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/add_centre',
        method: 'post',
        data
    })
...
export function centreList(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/centre_list',
        method: 'post',
        data
    })
...
export function contractSignNameList(centreId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/contract_sign_name',
        method: 'post',
        data
    })
...
export function creditEnterprise(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/credit_enterprise',
        method: 'post',
        data
    })
}
...
export function creditRepre(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/credit_repre',
        method: 'post',
        data
    })
}
...
export function creditGuarantor(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/credit_guarantor',
        method: 'post',
        data
    })
}
...
export function refreshCentreAccount({ supplierId, centreId }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/refresh_centre_account',
        method: 'post',
        data
    })
}
...
export function resetFaceCheckTimes(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/reset_face_check_times',
        method: 'post',
        data
    })
}
...
export function getQueryReview(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/query_review',
        method: 'post',
        data
    })
}
...
export function addKnow({ supplierId, content }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/add_know',
        method: 'post',
        data
    })
}
...
export function deleteKnow(id) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/delete_know',
        method: 'post',
        data
    })
}
...
export function validationInfo(supplierId) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/validation_info',
        method: 'post',
        data
    })
}
...
export function verifyValidationInfo({ item, id }) {
    ...
    return fetch({
        url: test + '/agent-api/supplier_register/verify_validation_info',
        method: 'post',
        data
    })
}
