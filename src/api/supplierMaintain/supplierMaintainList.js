 ...
 * @param status 阶段状态
 */
export function getListData({ limit, page, enterpriseName, businessLicenseNo, repreName, repreMobile, status, customerType }) {
    const data = {
        limit,
        page,
        enterpriseName,
    ...
    return fetch({
        url: test + '/agent-api/supply_data/list',
        method: 'post',
        data
    })
}
...
export function getRegisterStatusList() {
    return fetch({
        url: test + '/agent-api/combobox/register_status_list',
        method: 'post'
    })
}
...
export function supplystatusList() {
    return fetch({
        url: test + '/agent-api/supply_data/supply_status_list',
        method: 'post'
    })
}
