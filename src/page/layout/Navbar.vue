<template>
  <el-menu class="navbar" mode="horizontal">
    <!-- <hamburger class="hamburger-container" :toggleClick="toggleSideBar" :isActive="sidebar.opened"></hamburger>  系统左边模块的显示隐藏控件 -->
    <tabs-view></tabs-view>
      ...
      UpdatePassword () {
        this.$refs.updateForm.validate(valid => {
          if (valid) {
            ...
            this.$store.dispatch('updatePasswordAgain', passwordInfo).then((response) => {
              this.loading = false
